...
$product_select_query="SELECT * FROM wishlist WHERE buyer_id='$bid'";
        ...
        <div class="row">
         <div class="col-lg-12">
            ...
            <div class="border-bottom border-gray-200 px-4 px-md-5 py-4">
                <h5 class="mb-0">Wishlist info</h5>
            </div>
            ...
            <div class="container mt-5">
                ...
                <button type="submit" name="save_from_wishlist" class="btn btn-secondary mb-3">Save</button>
                <button type="submit" name="confirm_order_from_wishlist" class="btn btn-info mb-3">Confirm Order</button>
                </div>
            </div>
            </form>
        </div>
