        ...
        <div class="col-lg-4">
            <div class="swiper-slide">
                ...
                <figcaption class="pt-3">
                    <div class="mb-2"><small class="star-icon big d-inline-flex align-items-center m-2"><span class="rounded-pill me-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16.416 15.6">
                    ...
                    <h5 class="m-2 title-box"><a href="#">HIFIMAN HE-35X Headphones</a></h5>
                    <span class="h6 m-2">$195</span>
                </figcaption>
                </figure>
            </div>
        </div>
