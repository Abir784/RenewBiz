              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control form-control-xl" placeholder="Full Name Required">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-4">
                    <label class="form-label form-label-lg">Email</label>
                    <input type="text" class="form-control form-control-xl" placeholder="Email Required">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-4">
                    <label class="form-label form-label-lg">Address</label>
                    <input type="text" class="form-control form-control-xl" placeholder="Address Required">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-4">
                    <label class="form-label form-label-lg">Phone Number</label>
                    <input type="int" class="form-control form-control-xl" placeholder="Phone Number Required">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-4">
                    <label class="form-label form-label-lg">Business Name</label>
                    <input type="text" class="form-control form-control-xl" placeholder="Business Name Required">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-4">
                    <label class="form-label form-label-lg">Business Industry</label>
                    <input type="text" class="form-control form-control-xl" placeholder="Business Industry Required">
                  </div>
                </div>
